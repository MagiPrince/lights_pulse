 ...
 * @param array_f_chapeau the array with the fourier transform values
 */
void tdf(float* array_f, float complex** array_wn, float complex* array_f_chapeau){

    float complex res_temp = 0;
    for (int i = 0; i < N; i++)
    {
        res_temp = 0;
        for (int j = 0; j < N; j++)
 ...
 * @param array_f_norm array that will contain the data normalized
